...
public abstract class AbstractFragment extends AbstractComponent implements IFragment {
    ...
    @Override
    public abstract FragmentConfiguration getConfiguration(final String name, final ComponentConfiguration parent);
    ...
    @Override
    public abstract void render(final OutWriterImplementationAdapter out, final FragmentConfiguration config);
